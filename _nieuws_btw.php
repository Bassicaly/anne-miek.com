<?php
	...
	$title = "Verhoging BTW";
	$description = "BTW verhoging heeft effect op het tarief van een behandeling. Onderteken de petitie";
	$keywords = "BTW verhoging Kunduz akkoord lente akkoord lagere vergoeding voor behandeling";
?>
